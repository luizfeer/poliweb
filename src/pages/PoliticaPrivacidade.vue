<template>
  <div class="p-4">
<h2><span style="color: rgb(68, 68, 68);" class="text-xl">Política Privacidade</span></h2>
<p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do Poliweb respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://www.poliwebapp.com.br/">Poliweb</a>, e outros sites que possuímos e operamos.</span></p>
...
<h3><span style="color: rgb(68, 68, 68);" class="text-xl">Compromisso do Usuário</span></h3>
<p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Poliweb oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
<ul>
