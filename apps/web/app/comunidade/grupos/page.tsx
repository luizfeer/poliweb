...
export const metadata = { title: 'Grupos e coletivos - Carmo Local' };
...
export default async function CommunityGroupsPage({
  ...
  return (
    <AppFrame className="bg-paper">
      <CommunityPageShell chips={['Grupos', 'WhatsApp', 'Cadastrar']}>
        <CommunityHero
          icon={UsersRound}
          kicker="Diretório da comunidade"
          title="Grupos e coletivos"
          description="Associações, ONGs, esportes, cultura, bairro e grupos com atividade prática na cidade."
          tone="green"
          action={
            <>
              <Link
                href="/comunidade/grupos/whatsapp"
          ...
          meta={
            <>
              <CommunityPill tone="green">{groups.length} grupos</CommunityPill>
              <CommunityPill tone="paper">Contato local</CommunityPill>
            </>
          }
        />
