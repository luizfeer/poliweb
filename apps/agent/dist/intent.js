export function classifyIntent(query) {
    ...
    if (/quero|tem|conhece|sabe|me indica|me recomenda|lista|guia|roteiro|roteiros|itinerario|itinerário|viagem|pousada|restaurante|hotel|atracao|lugar|onde (posso|consigo|encontro)|o que fazer/i.test(query)) {
        return 'search';
    }
    return 'generic';
}
